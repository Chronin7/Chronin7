...
from util_functions import clear_term
@dataclass
class Monster:
	name:str
	health:str
...
goodLoot = [
	...
	Item("ඞ++: sus++", health=100, damagebuff=100, predamage=100, type="consumable")
]
#worst
norm = [
	...
	Item("ඞ+: sus+", health=50, damagebuff=50, predamage=50, type="consumable")
]
#meh
rearer = [
	...
	Item("ඞ: sus", health=25, damagebuff=25, predamage=25, type="consumable")
]
